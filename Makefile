...
compress: BitOutputStream.o HCNode.o HCTree.o BitInputStream.o
#compress: BitOutputStream.o HCNode.o HCTree.o


uncompress: BitInputStream.o BitOutputStream.o HCNode.o HCTree.o

HCTree.o: BitOutputStream.hpp HCNode.hpp HCTree.hpp BitInputStream.hpp
#HCTree.o: BitOutputStream.hpp HCNode.hpp HCTree.hpp
